...
```toml
[dependencies]
strict-path = { version = "0.1.0-alpha.6", features = ["serde"] }
```
...
```toml
[dependencies]
strict-path = { version = "0.1.0-alpha.6", features = ["tempfile"] }
```Enables:
...
```toml
[dependencies]
strict-path = { version = "0.1.0-alpha.6", features = ["app-path"] }
```
