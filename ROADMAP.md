...
- Lexical `..` component blocking + canonicalization validation (defense-in-depth)
...
| 1.1.4                                            | Add debug formatting                              | ⏳      | 2 - HIGH     | Shows full path for debugging                          |
...
| 2.3.7                                            | Essential trait implementations                   | 🚧      | 1 - CRITICAL | `AsRef`, `Borrow`, `PartialEq`                         |
...
| 2.3.5                                            | Conversion methods (`into_path_buf`, etc.)        | 🚧      | 1 - CRITICAL | app-path compatibility                                 |
