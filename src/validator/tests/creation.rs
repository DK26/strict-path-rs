...
#[test]
fn test_jail_creation_with_existing_directory() {
...
fn test_marker_types_for_compile_time_safety() {
    ...
    let image_path: crate::path::jailed_path::JailedPath<ImageResource> =
    ...
    assert_eq!(
        std::mem::size_of::<crate::path::jailed_path::JailedPath<ImageResource>>(),
        expected_size,
