...
Operational guide for AI assistants,## Anti‑Patterns (Tell‑offs)

Do not implement leaky trait impls for secure types: and automation working in this repository.
